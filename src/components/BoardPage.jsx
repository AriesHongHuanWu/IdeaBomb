                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    {isMobile ? (
                        ...
                        <>
                            ...
                            <button onClick={() => setIsShareOpen(true)} style={{ background: theme.activeBg, color: theme.activeText, border: `1px solid ${theme.border}`, padding: '8px 16px', borderRadius: 20, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 5, fontWeight: 'bold' }}><FiUserPlus /> {t('invite') || 'Share'}</button>
