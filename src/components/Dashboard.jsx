...
import { FiPlus, FiLogOut, FiLayout, FiHome, FiFolder, FiUsers, FiGrid, FiShare2, FiClock, FiMoreVertical, FiEdit2, FiTrash2, FiMove, FiShield, FiGlobe, FiCheckCircle } from 'react-icons/fi'
...
export default function Dashboard({ user }) {
    ...
    const [showTodo, setShowTodo] = useState(false) // Todo Panel State
        ...
        <div style={{ minHeight: '100vh', background: '#f8f9fa', fontFamily: '"Google Sans", "Inter", sans-serif', overflowX: 'hidden' }}>
            ...
            <div style={{ display: 'flex', minHeight: 'calc(100vh - 70px)' }}>
                ...
                <div style={{
                    ...
                    {/* Share Section */}
                    <div style={{ padding: '0 20px', marginTop: 20, marginBottom: 10, fontSize: '0.8rem', fontWeight: 'bold', color: '#5f6368' }}>
                        {!isMobile && "SHARE WITH ME"}
                    </div>
                    <NavItem icon={<FiShare2 />} label="Shared Boards" active={activeView === 'shared'} onClick={() => { setActiveView('shared'); setSelectedFolder(null) }} isMobile={isMobile} />
                ...
                {/* Content Area */}
                <div style={{ flex: 1, padding: isMobile ? '20px' : 40, width: '100%', transition: 'all 0.3s' }}>
