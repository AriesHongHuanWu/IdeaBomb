export const translations = {
    en: {
        ...
        q4: 'Is my data secure?', a4: 'We use enterprise-grade encryption and secure Google authentication to ensure your ideas stay safe.',
        product: 'Product', overview: 'Overview', userGuide: 'User Guide', contact: 'Contact',
    ...
    'zh-TW': {
        ...
        product: '產品', overview: '總覽', userGuide: '使用者指南', contact: '聯絡我們',
        terms: '服務條款', privacy: '隱私權政策', rights: '版權所有。', createdBy: '由 AWBest Studio 製作',
        features: '功能', howItWorks: '如何運作', pricing: '價格', dashboard: '儀表板', signIn: '登入',
    }
}
